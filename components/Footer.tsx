...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full bg-black text-white overflow-hidden min-h-[600px]">
      ...
      <div className="px-12 pl-16 pt-10 pb-16">
        <div className="flex items-center gap-6">
          ...
          <h2
            className="text-5xl uppercase tracking-wider font-bold"
      ...
      {/* Main Content Grid */}
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8 px-12 pb-20">
        {/* Left Column - Services */}
        <div className="flex flex-col gap-3 pl-8">
          <h3
            className="text-4xl uppercase tracking-wider mb-2 font-bold"
            style={{ fontFamily: 'Norwige, sans-serif' }}
          >
            SERVICES
          </h3>
          ...
          >
            ...
            <li>
              <a href="/aeriel" className="hover:text-gray-400 transition-colors duration-300">Video Production</a>
            </li>
            <li>
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          ...
          >
            ...
            <div className="min-w-[200px] relative overflow-hidden">
          ...
          <video
            ...
            muted
            playsInline
            className="h-[140px] w-auto object-contain -mt-8"
          />
        </div>
      </div>

      {/* Atlanta Skyline Image - Positioned at bottom right, larger and extending beyond footer */}
      <div className="absolute -bottom-12 right-0 w-full h-[350px] pointer-events-none" style={{ filter: 'drop-shadow(0 -10px 30px rgba(255, 255, 255, 0.1))' }}>
        <Image
