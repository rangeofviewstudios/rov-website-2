...
- 2026-09-11: Price sweep. Code card ($80/hr, $100 single, packs 3/$250, 6/$400, 12/$700) is canonical; every copy surface now says you leave with stems plus whatever was mixed in session, and the full mix and master is a separate line. Studio b-roll clips on the home page replaced by five session photos, spread across the act breaks, the studio section, and the closing CTA (no captions; components/sound/SessionPhoto.tsx).
